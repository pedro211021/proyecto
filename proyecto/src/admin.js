        ...
        : `<ul>
          ${estudiantes
            ...
            <li style="margin-bottom:8px;">
              <strong>${escapeHtml(est.nombre)}</strong> (${escapeHtml(est.correo)}) - ${escapeHtml(est.telefono || "Sin teléfono")}
              <button data-id="${est.id}" class="borrar-estudiante" style="margin-left:8px;">🗑️ Eliminar</button>
            </li>`
            )
            .join("")}
        </ul>`
